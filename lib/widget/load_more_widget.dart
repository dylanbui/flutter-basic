...
class DbLoadMore extends StatefulWidget {
...
class _LoadMoreState extends State<DbLoadMore> {
  Widget get child => widget.child;

  LoadMoreDelegate get loadMoreDelegate =>
      widget.delegate ?? DbLoadMore.buildDelegate();
    ...
    return NotificationListener<_RetryNotify>(
      child: NotificationListener<_BuildNotify>(
        child: DefaultLoadMoreView(
          ...
          textBuilder: widget.textBuilder ?? DbLoadMore.buildTextBuilder(),
        ),
